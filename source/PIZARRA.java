...
int MARCOROJO = color(175, 347, 252);
int MARCOVERDE = color(0, 255, 0);
int MARCOAZUL = color(0, 0, 255);
int MARCOBLANCO = color(255, 255, 255);
int MARCOYELLOW = color(245, 234, 60);
int MARCONEGRO = color(0, 0, 0);
int MARCONARANJA = color(235, 171, 70);
int MARCOROSA = color(210, 27, 212);
int MARCOELIPSE = color(0);
int GATOCOLOR = color (0, 0, 0);
int VACACOLOR = color (0, 0, 0);
int JIRAFCOLOR = color (0, 0, 0);
int CONTADORC = 0;
int CONTADORB =0;
...
int CIRCULINEA = color(0, 0, 0);
int CIRCUFILL1 = color(0);
int CIRCUFILL2 = color(R, G, B);

float R1 = random(5, 255.1f);
float G1 = random(5, 255.1f);
float B1 = random(5, 255.1f);

float R2 = random(5, 255.1f);
float G2 = random(5, 255.1f);
float B2 = random(5, 255.1f);

float R3 = random(5, 255.1f);
float G3 = random(5, 255.1f);
float B3 = random(5, 255.1f);
//******************************************************************************************************
...
public void draw() {
  ...
  if (SWITCH1 == 5 && mouseButton == LEFT  && (mouseY<GUIASU-10 || mouseX>1095)) {
    ...
    fill(R2, G2, B2);
    ellipse(mouseX, mouseY, GROS*1.5f, GROS*1.5f);
...
public void mousePressed() {  
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--hide-stop", "PIZARRA" };
    if (passedArgs != null) {
